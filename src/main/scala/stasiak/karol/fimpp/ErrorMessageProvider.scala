...
/** Created with IntelliJ IDEA. User: karol Date: 06.10.12 Time: 09:52 To change
...
object Trollestia extends ErrorMessageProvider {
  def syntaxError(functionName: String) =
    "Now say, do you like mmm-syntax errors? You have one in function ‘" +
  ...
  def mismatchedFunctionNameInFooter(expected: String, found: String) =
    "This function is a changeling! At the beginning it was named ‘" +
      expected + "’, and now it's ‘" + found + "’!"
  def unknownError = "To the moon with that code!"
  def invalidIdentifier(id: String) =
    "‘" + id.capitalize + "’ ain't no pony I've heard of. Do they have tea parties with ‘" + id.capitalize + "’?"
}
